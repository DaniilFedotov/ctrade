# Generated by Django 5.0 on 2024-02-02 18:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revenue', models.GeneratedField(db_persist=False, expression=django.db.models.expressions.CombinedExpression(models.F('current_deposit'), '-', models.F('initial_deposit')), output_field=models.FloatField(), verbose_name='Revenue for trading bot')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revenue', models.GeneratedField(db_persist=False, expression=django.db.models.expressions.CombinedExpression(models.F('selling_price'), '-', models.F('purchase_price')), output_field=models.FloatField(), verbose_name='Revenue for deal')),
